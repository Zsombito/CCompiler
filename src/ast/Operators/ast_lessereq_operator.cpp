...
LesserEqOperator::LesserEqOperator(NodePtr left, NodePtr right)
{
    branches.push_back(left);
    branches.push_back(right);
}
void LesserEqOperator::CodeGen(std::ostream &output, Program_Data &program_data, int destReg, std::string type) const 
{
    ...
    else
    {
        ...
        output << "c.le.s"  << " $f" << leftReg << ", $f" << rightReg << std::endl;

...
EqualOperator::EqualOperator(NodePtr left, NodePtr right)
{
    branches.push_back(left);
    branches.push_back(right);
}
void EqualOperator::CodeGen(std::ostream &output, Program_Data &program_data, int destReg, std::string type) const 
{
    ...
    if(realType != "float")
    {
        ...
        output << "beq $" << leftReg << ", $" << rightReg << ", " << label_one << std::endl;
        output << "nop" << std::endl;
